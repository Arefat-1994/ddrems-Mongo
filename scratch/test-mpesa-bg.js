...
async function testBuyGoods() {
  console.log('--- Testing CustomerBuyGoodsOnline ---');
  ...
  try {
    ...
    const payload = {
      MerchantRequestID: `TEST-BG-${Date.now()}`,
      BusinessShortCode: SHORTCODE,
      Password: password,
      Timestamp: timestamp,
      TransactionType: 'CustomerBuyGoodsOnline', // CHANGED
      Amount: 1,
      PartyA: '251911223344',
      PartyB: SHORTCODE,
      PhoneNumber: '251911223344',
      CallBackURL: 'https://webhook.site/852f46fe-65c6-406a-9466-06fce89d67a2',
      AccountReference: 'TEST-BG',
      TransactionDesc: 'Buy Goods Test'
    };
