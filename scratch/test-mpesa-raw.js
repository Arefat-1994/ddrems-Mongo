...
async function testRaw() {
  console.log('--- Testing RAW Passkey as Password ---');
  ...
  try {
    ...
    const payload = {
      MerchantRequestID: `TEST-RAW-${Date.now()}`,
      BusinessShortCode: SHORTCODE,
      Password: PASSKEY, // RAW PASSKEY
      Timestamp: timestamp,
      ...
      AccountReference: 'TEST-RAW',
      TransactionDesc: 'Raw Test'
    };
