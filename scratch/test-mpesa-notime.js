...
async function testNoTimestamp() {
  console.log('--- Testing Password = Base64(Shortcode + Passkey) ---');
  ...
  try {
    ...
    // 2. STK Push with password = base64(Shortcode + Passkey)
    ...
    const payload = {
      MerchantRequestID: `TEST-NOTIME-${Date.now()}`,
      ...
      AccountReference: 'TEST-NOTIME',
      TransactionDesc: 'No Timestamp Test'
    };
