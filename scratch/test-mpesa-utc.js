...
async function testUTC() {
  console.log('--- Testing KENYA Formula with UTC Timestamp ---');
  ...
  try {
    ...
    console.log('Using Timestamp (UTC):', timestamp);
    console.log('Using Password (B64 of SC+PK+TS):', password);

    const payload = {
      MerchantRequestID: `TEST-UTC-${Date.now()}`,
      ...
      AccountReference: 'TEST-UTC',
      TransactionDesc: 'UTC Test'
    };
