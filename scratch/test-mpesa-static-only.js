...
async function testStaticPassOnly() {
  console.log('--- Testing Static Password + CURRENT Timestamp ---');
  ...
  try {
    ...
    const payload = {
      MerchantRequestID: `TEST-STATIC-ONLY-${Date.now()}`,
      ...
      AccountReference: 'TEST-STATIC-ONLY',
      TransactionDesc: 'Static Only Test'
    };
