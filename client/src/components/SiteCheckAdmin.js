              ...
              <div key={check.id} className="sca-check-card">
                ...
                <div className="sca-check-card-body">
                  ...
                  <div className="sca-check-photo">
                    {check.photo_url ? (
                      <>
                        <img src={check.photo_url.startsWith('http') ? check.photo_url : `${window.API_BASE}${check.photo_url}`} alt="Site check" />
                    ...
                    <tr key={doc.id}>
                      ...
                      <td>
                        <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexWrap: 'wrap' }}>
                          <a
                            href={doc.document_url?.startsWith('http') ? doc.document_url : `${window.API_BASE}${doc.document_url}`}
                            target="_blank"
