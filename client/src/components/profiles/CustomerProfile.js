  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profile) {
        ...
        await axios.put(`${process.env.REACT_APP_API_URL || `http://${window.location.hostname}:5000`}/api/profiles/customer/${profile.id}`, { ...formData, phone_number: fullPhoneNumber });
        ...
        // Create new profile
        await axios.post(`${process.env.REACT_APP_API_URL || `http://${window.location.hostname}:5000`}/api/profiles/customer`, {
          ...formData,
