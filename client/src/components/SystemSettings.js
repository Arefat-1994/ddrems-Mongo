...
const SystemSettings = ({ user, onLogout, onSettingsClick }) => {
  ...
  const fetchLoginAttempts = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/auth/login-attempts`);
  ...
  const handleUnbanUser = async (userId) => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/auth/unban/${userId}`, { adminId: user?.id });
  ...
  const fetchServiceControls = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/service-control`);
  ...
  const fetchSchedule = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/service-control/schedule`);
  ...
  const handleAddServiceControl = async () => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/service-control`, {
  ...
  const handleDeleteServiceControl = async (id) => {
    try {
      await axios.delete(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/service-control/${id}`);
  ...
  const handleSaveSchedule = async () => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/service-control/schedule`, { ...schedule, modified_by: user?.id });
  ...
  const handleForceToggle = async (close) => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/service-control/schedule/force-toggle`, {
  ...
  const fetchSettings = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/system-settings`);
  ...
  const saveSettings = async () => {
    setSaving(true);
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/system-settings`, settings);
  ...
  const confirmSystemAction = async () => {
    setSaving(true);
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || (window.location.hostname.includes('vercel.app') ? 'https://ddrems-mongo.onrender.com' : `http://${window.location.hostname}:5000`)}/api/system-settings/action/${confirmAction}`);
