  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (paymentForm.receipt_document) {
        ...
        const uploadRes = await axios.post(`${window.API_URL}/upload`, formData, {
      ...
      const confirmRes = await axios.post(`${window.API_URL}/payment-confirmations`, {
      ...
      await axios.put(`${window.API_URL}/agreement-requests/${agreementRequest.id}`, {
