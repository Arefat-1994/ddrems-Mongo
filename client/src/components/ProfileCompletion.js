...
const ProfileCompletion = ({ user, onLogout, setCurrentPage }) => {
  ...
  const fetchCompletionStatus = async () => {
    try {
      const response = await axios.get(
        `${window.API_URL}/profile-approval/completion-status/${user?.id}`
      );
  ...
  const updateCompletionStatus = async (updates) => {
    try {
      const response = await axios.post(
        `${window.API_URL}/profile-approval/update-completion/${user?.id}`,
        updates
      );
  ...
  const submitForApproval = async () => {
    try {
      const response = await axios.post(
        `${window.API_URL}/profile-approval/submit-for-approval/${user?.id}`,
